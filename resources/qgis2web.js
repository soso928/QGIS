...
map.getView().fit([82.100647, -19.198391, 152.899353, 34.198390], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Inundation Map </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (17 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'QGIS2Web Test Map';
            }
